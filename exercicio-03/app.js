...
// console.log(brazilianFoods[1] = "Pão de Queijo");
...
const dessert = `${dogNames[0][dogNames[0].length - 2]}${dogNames[0][dogNames[0].length - 1]}${dogNames[1][dogNames[1].length - 2]}${dogNames[1][dogNames[1].length - 1]}${dogNames[3][dogNames[3].length - 2]}${dogNames[3][dogNames[3].length - 1]}`.replace('n','d');
