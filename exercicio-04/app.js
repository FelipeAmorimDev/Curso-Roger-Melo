...
const my3FavoriteTVShows = ["Lost","The 100","1899"];
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(",")}.`.replace(',1',' e 1').replace(",",", ")
...
*/
const number = 39
// console.log(`A string que a "typeSentence" armazena tem mais ${number} caracteres? ${ String(typeSentence.length > number).replace("t","T")}.`)
